...
\documentclass[UTF8, fontset=fandol]{beamer}
...
\titlegraphic{
    % \includegraphics[width=2cm]{pic/tjulogo.png}
    \includegraphics[height=1cm]{pic/TankLabBottom.png}
}
\logo{
    \includegraphics[height=0.6cm]{pic/tjulogo.eps}
}
\author{xxx~xxx}
\title{组会汇报}
\subtitle{小组名称}
...
\lstset{
    ...
    \begin{exampleblock}{命令}
      ...
      \begin{tabular}{llll}
        ...
        脚注 & 列表条目 & 标题 & 插入图片 \\\hline
          \cmd{label} & \cmd{cite}\cite{origin} & \cmd{ref} \\
  ...
  \begin{frame}[allowframebreaks]
    \bibliography{ref}
    \bibliographystyle{ref.buk}
    % 如果参考文献太多的话，可以像下面这样调整字体：
    % \tiny\bibliographystyle{ref}
  \end{frame}
